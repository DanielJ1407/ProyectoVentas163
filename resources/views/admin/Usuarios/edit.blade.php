            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="bi bi-person-plus"></i> Editar datos de Usuario</h3>
                    </div>
                    
                    <div class="card-body">
                        <form action="{{url('/admin/usuarios/'.$administrador->idEmpleado)}}" method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="text" class="form-control" id="idEmpleado" name="idEmpleado" 
                                                placeholder="ID de Usuario" value="{{ $administrador->idEmpleado }}">
                                        </div>
                                        @error('idEmpleado')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="text" class="form-control" id="ci" name="ci" 
                                                placeholder="Ej: 12345678" value="{{ $administrador->empleado->ci }}">
                                        </div>
                                        @error('ci')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="text" class="form-control" id="nombreE" name="nombreE" 
                                                placeholder="Nombre(s) del Usuario" value="{{ $administrador->empleado->nombreE }}">
                                        </div>
                                        @error('nombre')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="text" class="form-control" id="apellidoE" name="apellidoE" 
                                                placeholder="Apellido(s) del Usuario" value="{{ $administrador->empleado->apellidoE }}">
                                        </div>
                                        @error('apellido')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="number" class="form-control" id="nroContacto" name="nroContacto" 
                                                placeholder="Número de contacto" value="{{ $administrador->empleado->nroContacto }}">
                                        </div>
                                        @error('nroContacto')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="text" class="form-control" id="userAdmi" name="userAdmi" 
                                                placeholder="Ej: usuario@ejemplo.com" value="{{ $administrador->userAdmi }}">
                                        </div>
                                        @error('userAdmi')
                                            <div class="error-message">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-icon">
                                            ...
                                            <input type="password" class="form-control" id="passwordAdmi" name="passwordAdmi" 
                                                placeholder="Contraseña" value="{{ $administrador->passwordAdmi }}">
                                        </div>
