                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="idProducto" name="idProducto" value = "{{ $producto->idProducto }}" placeholder="Ingrese el ID del producto">
                            </div>
                            @error('idProducto')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="marca" name="marca" placeholder="Ingrese la marca del producto" value = "{{ $producto->marca }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
