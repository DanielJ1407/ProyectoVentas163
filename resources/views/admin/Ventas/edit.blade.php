...
@section('content')
<div class="container">
    <form action="{{ url('/admin/ventas/'.$producto->idProducto.'/'.$detalleVenta->idDetalle_venta) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="ci" name="ci" value="{{$cliente->ci}}">
                    </div>
                    {{-- Nombre --}}
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="idDetalle_venta" name="idDetalle_venta" value="{{$detalleVenta->idDetalle_venta}}">
                    </div>
                    {{-- Nro Venta --}}
                    <div class="col-md-3 mb-3">
                        <label for="nroVenta" class="form-label">Nro Venta</label>
                        <input type="number" class="form-control" id="nroVenta" name="nroVenta" value="{{$detalleVenta->nroVenta}}">
                    </div>
                    {{-- Método Pago --}}
                    <div class="col-md-3 mb-3">
                        <label for="metodo_pago" class="form-label">Método de Pago</label>
                        <select class="form-select" id="metodo_pago" name="metodo_pago">
                            <option value="{{$detalleVenta->metodo_pago}}">{{$detalleVenta->metodo_pago}}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" class="form-control" id="fecha_venta" name="fecha_venta" value="{{$detalleVenta->fecha_venta}}">
                    </div>
                    {{-- Hora Venta --}}
                    <div class="col-md-3 mb-3">
                        <label for="hora_venta" class="form-label">Hora</label>
                        <input type="time" class="form-control" id="hora_venta" name="hora_venta" value="{{$detalleVenta->hora_venta}}">
                    </div>
                    {{-- Empleado --}}
                    <div class="col-md-3 mb-3">
                        <label for="idEmpleado" class="form-label">Vendedor</label>
                        <select class="form-select" id="idEmpleado" name="idEmpleado">
                            <option value="{{ $empleados->first()->idEmpleado }}">{{ $empleados->first()->nombreE }} {{ $empleados->first()->apellidoE }} (CI: {{ $empleados->first()->ci }})</option>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="idProducto" name="idProducto">
                            <option value="{{ $producto->first()->idProducto }}" >{{ $producto->first()->nombre_producto }} — Bs{{ number_format($producto->first()->precio_unitario,2) }}</option>
