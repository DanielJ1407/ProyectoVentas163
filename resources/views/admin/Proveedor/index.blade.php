...
@section('content')
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <h3>{{ $proveedores->unique('ubicacion')->count() }}</h3>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <h3>{{ $proveedores->unique('tipo')->count() }}</h3>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <h3>{{ $proveedores->unique('nroContacto')->count() }}</h3>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="bi bi-truck me-2"></i> Proveedores Registrados</h3>
                <a class="btn btn-primary" href="{{url('/admin/proveedores/create')}}">
                            ...
                            @if(count($proveedores) > 0)
                                @foreach($proveedores as $proveedor)
                                    <tr>
                                        ...
                                        <td>
                                            <div>{{ $proveedor->nombreProv }}</div>
                                        </td>
                                        <td>
                                            <div href="{{ $proveedor->nroContacto }}" class="badge-tag">
                                                <i class="bi bi-telephone me-1"></i> {{ $proveedor->nroContacto }}
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ url('/admin/proveedores/'.$proveedor->idProveedor) }}" class="btn btn-info">
                                                    <i class="bi bi-eye"></i> Ver
                                                </a>
                                                <a href="{{ url('/admin/proveedores/'.$proveedor->idProveedor.'/edit') }}" class="btn btn-warning">
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <p>Comienza agregando nuevos proveedores a tu sistema</p>
                                            <a class="btn btn-primary mt-3" href="{{url('/admin/proveedores/create')}}">
